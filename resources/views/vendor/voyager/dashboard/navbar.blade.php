    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav @if (__('voyager::generic.is_rtl') == 'true') navbar-left @else navbar-right @endif">
            ...
            {{--end change language--}}
             <li class="dropdown profile">
                <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button"
                aria-expanded="false">{{ config('app.locale') == "en" ? 'EN' : 'VI' }}</a>
                <ul class="dropdown-menu dropdown-menu-animated">
                    <li>
                        <a class="{{ config('app.locale') == "en" ? 'active' : '' }}" href="{{route('change_language',['language'=>'en'])}}">EN</a>
                    </li>
                    <li>
                        <a class="{{ config('app.locale') == "vi" ? 'active' : '' }}"  href="{{route('change_language',['language'=>'vi'])}}">VI</a>
                    </li>
                </ul>
            </li>
        </ul>
