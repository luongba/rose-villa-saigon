...
{{-- 
        ...
        <li class="nav-item nav-center has-child-menu">
            ...
            <a class="nav-link nav-link-new" href="{{URL::to('stay/deluxe-suites')}}">{{ trans('pages.Stay') }}</a>
        ...
        <li class="nav-item nav-center has-child-menu">
            ...
            <a class="nav-link nav-link-new" href="{{URL::to('celebrate/the-atelier')}}">{{ trans('pages.Celebrate') }}</a>
            ...
            <a class="nav-link nav-link-new" href="{{URL::to('dine/rose-garden')}}">{{ trans('pages.Dine') }}</a>
        ...
        <li class="nav-item nav-center has-child-menu">
            ...
            <a class="nav-link nav-link-new" href="{{URL::to('relax/the-spa')}}">{{ trans('pages.Relax') }}</a>
        ...
        <li class="nav-item nav-center "><a class="nav-link nav-link-new" href="{{URL::to('entertain/rose-garden')}}">{{ trans('pages.Entertain') }}</a></li>
        ...
        <li class="nav-item nav-center">
                    ...
                    <div class="footer__follow">
                      ...
                      <a href="ttps://www.instagram.com/"><img src="{{ asset('public/images/icons/icon.jpg') }}" alt="" class="img__follow"></a>
        ...
        <div class="control">
            ...
            <div class="control__menu">
                ...
                <h4 class="control__menu-text">
                    ...
                    EXPLORE <br><span class="title-font">Rose Villa</span>
                ...
                <img src="{{ asset('public/images/bg/logo-mainpage.png') }}" alt="" class="img__logo">

            </a>

            <a href="http://rosevilla.tntechs.com.vn/public/images/maplogo.jpg" target="_blank" class="maplinklogo1"><img class="icon-mapclick" src="{{ asset('public/images/bg/logo-mainpage.png') }}"></a>
            ...
            <a href="javascript:;" data-toggle="modal" data-target="#popup-login" class="control__login">
                ...
                <h4 class="control__login-text">
                    ...
                    YOUR <br><span class="title-font">Membership</span>
