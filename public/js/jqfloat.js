(function (e) {
    var t = {
        init: function (t) {
            return this.each(function () {
                ...
                var n = e("<div/>").css({ width: e(this).outerWidth(true), height: e(this).outerHeight(true), "z-index": e(this).css("zIndex") });
                if (e(this).css("position") == "absolute") n.css({ position: "absolute", top: e(this).position().top, left: e(this).position().left });
                else n.css({ float: e(this).css("float"), position: "relative" });
                if ((e(this).css("marginLeft") == "0px" || e(this).css("marginLeft") == "auto") && e(this).position().left > 0 && e(this).css("position") != "absolute") {
                    n.css({ marginLeft: e(this).position().left });
                }
                e(this).wrap(n).css({ position: "absolute", top: 0, left: 0 });
            });
        },
        update: function (t) {
            e(this).data("jSetting", e.extend({}, e.fn.jqFloat.defaults, t));
    ...
    var n = function (t) {
        ...
        e(t)
            .stop()
            .animate({ top: s, left: i }, o, function () {
                if (e(this).data("jFloating")) n(this);
                else e(this).animate({ top: 0, left: 0 }, o / 2);
            });
    };
    ...
    e.fn.jqFloat.defaults = { width: 100, height: 100, speed: 1e3, minHeight: 0 };
})(jQuery);
